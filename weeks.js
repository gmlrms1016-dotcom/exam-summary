...
(function () {
    ...
    /* DATA:BEGIN */
    var WEEK_DATA = {
        "프로그래밍언어실습": { 1: "강의소개 / C 개요", 2: "C 기본 실습 (ch02)", 3: "변수·상수·자료형 (ch03)", 4: "연산자 (ch05)", 8: "중간고사 시험문제 정리 (1~4주차 반영)" },
        "운영체제실습": { 1: "리눅스 환경 / 기본 명령어", 2: "리눅스 명령어 실습", 3: "마운트 · 링크 · 권한 · 사용자관리", 4: "사용자·그룹 관리 · rpm·dnf 패키지 설치", 8: "중간고사 시험문제 정리 (1~4주차 반영)" },
        "웹프로그래밍": { 1: "강좌 OT / 웹 개요", 2: "<9월 1일> 실행단계·이벤트·함수·객체", 3: "<9월 8일> 변수·자료형·형변환·객체", 4: "<9월 15일> 연산자·truthy/falsy·단락 평가", 5: "<9월 22일> 함수·콜백·객체·배열", 8: "중간고사 시험문제 정리 (1~5주차 반영)" },
        "데이터베이스관리": { 1: "강의소개 / DB 개념", 2: "DB 정의·특징 / MySQL 실습", 3: "DBMS·데이터언어·기본키", 4: "관계형 데이터 모델·기본키/외래키·스키마", 5: "키 5종 · 뷰(view) · 널 값 · INSERT", 8: "중간고사 시험문제 정리 (1~5주차 반영)" },
        "자바프로그래밍": { 1: "강의소개 / 첫 프로그램", 2: "1장 자바 개요", 3: "2장 자료형·연산자·조건문", 4: "2장 실습 + 3장 반복문·배열·예외처리", 5: "3장 반복문·배열 실습 (while · 중첩 for · continue · break · 배열)", 8: "중간고사 시험문제 정리 (1~5주차 반영)" }
    };
    /* DATA:END */
